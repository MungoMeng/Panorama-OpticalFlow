...
namespace optical_flow {
    ...
    void NovelViewGeneratorAsymmetricFlow::prepare(
        ...
        warpPerspective(imageL,n_imageL,shftMat,Size(imageL.cols+2*length,imageL.rows),INTER_NEAREST,BORDER_CONSTANT,cv::Scalar(0,0,0,0));
        ...
        warpPerspective(imageR,n_imageR,shftMat,Size(imageL.cols+2*length,imageL.rows),INTER_NEAREST,BORDER_CONSTANT,cv::Scalar(0,0,0,0));
