...
int main(int argc, char** argv) {
    ...
    for(int i = 1; i <= 5; i++){
        ...
        //imwriteExceptionOnFail(FLAGS_test_dir + "/process"+ char(i+48) + "/OverlappedR.png", StoolsgetOverlappedR());
        ...
        //buildvisualizations(novelViewGen->getFlowLtoR(),novelViewGen_>getFlowRtoL(),colorImageL,colorImageR);
